...
event OnInit()
	; Scrabs Edit:
	; Disable MQ101 while Stage [0, 255] -> Disable while Stage ]5, 255]
...
event OnAnimationEvent(ObjectReference akSource, string asEventName)
	if(asEventName == "FootLeft")
		; Scrab Edit
		; Valid if Stage >= 255 or completed -> or  stage below 10
		; if(MQ101.isStageDone(255)) || (MQ101.isRunning() == false)
		if(MQ101.isStageDone(255)) || (MQ101.isRunning() == false || GetStage() < 10)
