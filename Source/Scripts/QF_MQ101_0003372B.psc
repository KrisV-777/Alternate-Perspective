...
;BEGIN CODE
; AP - Reserved, Start Vanilla Intro here
;END CODE
EndFunction
;END FRAGMENT
...
; Give Ulfric back his Cuffs since we had to remove them on game start
Alias_Ulfric.GetActorRef().AddItem(PrisonerCuffs, 1)
Utility.Wait(0.1)
Alias_Ulfric.GetActorRef().EquipItem(PrisonerCuffs)
;END CODE
EndFunction
;END FRAGMENT
...
;make sure Ulfric has the right outfit, since I dont wanna edit the actual npc entry
